...
<p>This guide covers the 'Corporate Evaluation' service. The guide for the 'Programme Evaluation' can be found <a href="/action/welcome?page=proghelp">here</a>.</p>
...
<p>'Corporate Evaluation' allows key news and Corporate messages to be evaluated.  It can be accessed by clicking on the 'Evaluation' button.</p>
...
<a name="search"></a>
<p>* The Publication and Journalist selection are selected by typing a search phrase in the 
...
<h4>Stage 2 - Topic Filter</h4>

<p>This page allows the topics or subjects to be selected that will appear in the final report. This page is only visible in the "Evaluation" service.</p>

<h5>Topic</h5>

<p>Select the topics required to appear in the report. This lists both a client's Topics and Programmes set up for them by xymedia. If you wish to change this list please contact Mediagen.</p>
...
<p>If Topic and Publication are selected one row per Topic/Publication combination will be generated and the following will be created:

<table>
	<thead>
		<tr><th>Topic</th><th>Publication</th><th>Count</th></tr>
	</thead>
	<tbody>
